...
const miroData = {
    ...
    cards: {
        major: [
            { name: "The Fool", meaning: "Beginnings, innocence, spontaneity, free spirit", image: "decks/miro-tarot-cards/01-the-fool.png" },
            { name: "The Magician", meaning: "Manifestation, resourcefulness, power, inspired action", image: "decks/miro-tarot-cards/02-the-magician.png" },
            { name: "The High Priestess", meaning: "Intuition, sacred knowledge, divine feminine, subconscious", image: "decks/miro-tarot-cards/03-the-high-priestess.png" },
            { name: "The Empress", meaning: "Femininity, beauty, nature, nurturing, abundance", image: "decks/miro-tarot-cards/04-the-empress.png" },
            { name: "The Emperor", meaning: "Authority, structure, control, fatherhood", image: "decks/miro-tarot-cards/05-the-emperor.png" },
            { name: "The Hierophant", meaning: "Spiritual wisdom, religious beliefs, conformity, tradition", image: "decks/miro-tarot-cards/06-the-hierophant.png" },
            { name: "The Lovers", meaning: "Love, harmony, relationships, values alignment", image: "decks/miro-tarot-cards/07-the-lovers.png" },
            { name: "The Chariot", meaning: "Control, willpower, success, action, determination", image: "decks/miro-tarot-cards/08-the-chariot.png" },
            { name: "Strength", meaning: "Strength, courage, persuasion, influence, compassion", image: "decks/miro-tarot-cards/09-strength.png" },
            { name: "The Hermit", meaning: "Soul searching, introspection, being alone, inner guidance", image: "decks/miro-tarot-cards/10-the-hermit.png" },
            { name: "Wheel of Fortune", meaning: "Good luck, karma, life cycles, destiny, turning point", image: "decks/miro-tarot-cards/11-wheel-of-fortune.png" },
            { name: "Justice", meaning: "Justice, fairness, truth, cause and effect, law", image: "decks/miro-tarot-cards/12-justice.png" },
            { name: "The Hanged Man", meaning: "Pause, surrender, letting go, new perspectives", image: "decks/miro-tarot-cards/13-the-hanged-man.png" },
            { name: "Death", meaning: "Endings, change, transformation, transition", image: "decks/miro-tarot-cards/14-death.png" },
            { name: "Temperance", meaning: "Balance, moderation, patience, purpose", image: "decks/miro-tarot-cards/15-temperance.png" },
            { name: "The Devil", meaning: "Shadow self, attachment, addiction, restriction, sexuality", image: "decks/miro-tarot-cards/16-the-devil.png" },
            { name: "The Tower", meaning: "Sudden change, upheaval, chaos, revelation, awakening", image: "decks/miro-tarot-cards/17-the-tower.png" },
            { name: "The Star", meaning: "Hope, faith, purpose, renewal, spirituality", image: "decks/miro-tarot-cards/18-the-star.png" },
            { name: "The Moon", meaning: "Illusion, fear, anxiety, subconscious, intuition", image: "decks/miro-tarot-cards/19-the-moon.png" },
            { name: "The Sun", meaning: "Positivity, fun, warmth, success, vitality", image: "decks/miro-tarot-cards/20-the-sun.png" },
            { name: "Judgement", meaning: "Judgement, rebirth, inner calling, absolution", image: "decks/miro-tarot-cards/21-judgement.png" },
            { name: "The World", meaning: "Completion, integration, accomplishment, travel", image: "decks/miro-tarot-cards/22-the-world.png" }
        ],
        cups: [
